...
namespace SlimUI.ModernMenu{
	public class UIMenuManager : MonoBehaviour {
		...
		public void PlayCampaign(){
            ...
            // Load the game scene
            string gameSceneName = "SciFi_Warehouse"; 
		...
		IEnumerator LoadAsynchronously(string SciFi_Warehouse){ // scene name is just the name of the current scene being loaded
			AsyncOperation operation = SceneManager.LoadSceneAsync(SciFi_Warehouse);
			...
			while (!operation.isDone){
				...
				if (operation.progress >= 0.9f && waitForInput){
                    loadPromptText.text = "Press ENTER or RETURN to continue";
                    loadingBar.value = 1;
